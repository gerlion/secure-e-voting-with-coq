...
(* Require Import Primes.EGprimeQ. 
Require Import Primes.EGprimeP. *)
Require Import Coq.ZArith.Znat.
...
Definition P : Z := .
Definition Q : Z := 115792089237316195423570985008687907853269984665640564039457584007913129639747.
...
Module ElectionGuardG <: GroupSig.
  Definition G := G.
...
Module ElectionGuardF <: FieldSig.
  Definition F := F.
...
Module ElectionGuardVS <: VectorSpaceSig ElectionGuardG ElectionGuardF.
